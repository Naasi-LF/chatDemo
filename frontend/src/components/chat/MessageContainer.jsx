...
const MessageContainer = () => {
  ...
  if (!selectedUser) {
    return (
      <div className="h-full flex items-center justify-center bg-base-200/50">
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header - 固定在顶部 */}
      <div className="flex-none p-4 border-b border-base-200 flex items-center gap-3 bg-base-100">
